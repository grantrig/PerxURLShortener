...
Vagrant.configure(2) do |config|
  ...
  config.vm.network :forwarded_port, guest: 22, host: 3230, id: 'ssh'
  ...
  config.vm.provision :shell, :path => "vagrant_shell_scripts/mysql.sh",  :args => "", privileged: true
